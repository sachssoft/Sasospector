...
namespace Sachssoft.Sasospector.Views
{
    ...
    public class InspectorControl : TemplatedControl
    {
        ...
        private InspectorPropertyEditorRegistry _editorRegistry = InspectorPropertyEditorRegistry.Default;
        private ItemsControl? _partPropertyGrid = null;

        public static readonly DirectProperty<InspectorControl, InspectorPropertyEditorRegistry> EditorRegistryProperty =
            AvaloniaProperty.RegisterDirect<InspectorControl, InspectorPropertyEditorRegistry>(
        ...
        {
            SetValue(EditorRegistryProperty, InspectorPropertyEditorRegistry.Default);
        }
        ...
        public InspectorPropertyEditorRegistry EditorRegistry
        {
            get => _editorRegistry;
            set => SetAndRaise(EditorRegistryProperty, ref _editorRegistry,
                value ?? InspectorPropertyEditorRegistry.Default);
        }
